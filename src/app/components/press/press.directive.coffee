  ...
  .directive 'appPress', ($rootScope)->
    ...
    pressController = ($state) ->
      ...
      pr.data =
        ...
        'presses': [
          {
            'image': $rootScope.global.imageUrl + 'press_1.jpg'
            'date': 'DEC 27, 2015'
            'title': 'CES 2016'
          ...
          {
            'image': $rootScope.global.imageUrl + 'press_2.jpg'
            'date': 'DEC 21, 2015'
          ...
          {
            'image': $rootScope.global.imageUrl + 'press_3.jpg'
            'date': 'DEC 12, 2015'
            'title': 'IFA Berlin'
